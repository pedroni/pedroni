    ...
    >
      <div
        className={classNames(
          'hidden font-mono font-extralight uppercase text-white/50 lg:block tracking-wider',
          {
            'text-sm': size === 'sm',
            'text-base': size !== 'sm'
          }
      ...
      <div
        className={classNames('relative font-serif text-primary pb-3', {
          'text-xl': size === 'sm',
          'text-3xl': size !== 'sm'
        })}
      >
        ...
        <div
          className={classNames('absolute h-0.5 w-14 bg-primary bottom-0', {
