...
<!-- this probably deservers another post: There are certains aspects of AI that I find to be the most useful: I never really learned how to configure webpack, vite, nginx, and any other tool that is purely configuration, these are boring. I'm very happy that I didn't, configuration is something that AI is doing mostly right.-->
