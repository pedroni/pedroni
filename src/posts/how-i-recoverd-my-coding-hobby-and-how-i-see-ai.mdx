...
At work AI got the fun away, occasionally I code from scratch, out of boredom, an attempt to reclaim what once was fun. For productivity AI can handle most of it. Though it needs to be done carefully, or your energy and time will be drained. There's a hidden vicious cycle while "vibe coding", that can easily go unnoticed, which I only recently noticed. The satisfaction of hand writing a solution was replaced by a shallow relief of finally getting the AI to stop being wrong.
...
AI almost gets it, in fact sometimes it does, and more often than not, it doesn't. Our primal instinct is to keep chasing the end result, we keep chasing that dopamine hit with frustrated expectation and unsatisfied results. While chasing the result, time goes by without you even realizing it. Making you tired.
